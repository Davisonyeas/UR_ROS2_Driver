...
from ur_interfaces.msg import CurCartesian


class current_cartesian(Node):
    def __init__(self):
        super().__init__("current_cart")
    ...
    def timer_callback_cart(self):
        ...
        msg.debug_message = "Pose successfully published"
        self.publisher_.publish(msg)
        # Convert the pose array to a string before logging
        self.get_logger().info(f"Pose: {str(msg.pose)}")
